...
export const Home: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar đã có trong Shell */}

      <div className="flex-1 p-6 space-y-6">
        <Card className="w-full max-w-xl text-center shadow-lg transform hover:scale-105 transition-all duration-300">
        ...
        {user && sets.length > 0 && <VocabularyManager sets={sets} />}
        {user && sets.length === 0 && (
